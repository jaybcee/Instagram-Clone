...
func loadJpeg2(filepath string) (image.Image, error) {
...
func sameThing2(filepath string, i1 image.Image) float64 {

	i2, err := loadJpeg2(filepath)
	if err != nil {
		log.Fatal(err)
	}
